...
from app.crud.student import get_student, get_students, create_student, delete_student
...
async def test_create_student(mock_db_session):
    ...
    assert created_student.name == student_create.name
    assert created_student.email == student_create.email
    mock_db_session.add.assert_called_once()
    mock_db_session.commit.assert_called_once()
    mock_db_session.refresh.assert_called_once_with(created_student)
